#!/usr/bin/env python3
"""
Script para corrigir diagramação do Módulo 4 e organizar arquivos
"""
...
def fix_module4_formatting():
    """Corrige a diagramação do Módulo 4"""
    
    # Ler o notebook atual
    with open('curso/04_transfer_learning_aplicacoes_praticas.ipynb', 'r', encoding='utf-8') as f:
        notebook = json.load(f)
    
    # Reorganizar o conteúdo em células adequadas
    new_cells = []
    
    # Célula 1: Título e objetivos
    title_cell = {
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    # Célula 2: Estratégias de Transfer Learning
    strategies_cell = {
        "cell_type": "markdown",
        "metadata": {},
        "source": [
            ...
            "\n",
            "![Comparação das Estratégias de Transfer Learning](https://cdn.jsdelivr.net/gh/rfapo/visao-computacional@main/images/modulo04/estrategias_comparacao.png)\n",
            "\n",
            ...
            "\n",
            "![Pre-trained Initialization](https://raw.githubusercontent.com/rfapo/visao-computacional/main/images/modulo04/pre_trained_initialization.png)\n",
            "\n",
            "**Características:**\n",
    ...
    new_cells.append(strategies_cell)
    
    # Célula 3: Aplicações Práticas
    applications_cell = {
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    new_cells.append(applications_cell)
    
    # Célula 4: Resumo e Referências
    summary_cell = {
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    print("✅ Diagramação do Módulo 4 corrigida!")
    print("📝 Conteúdo reorganizado em 4 células")
    print("🔧 Quebras de linha e formatação restauradas")

def organize_files():
    """Organiza arquivos desnecessários na raiz para pasta utils"""
    ...
    # Arquivos para mover para utils
    files_to_move = [
        'GUIA_OTIMIZACAO_COLAB.md',
        'otimizacao_colab.py',
        'imagens_fallback.html',
        'comparacao_modelos_pretreinados.py'
    ]
    ...
    for file in files_to_move:
        if os.path.exists(file):
            ...
            print(f"📦 Movido: {file} → utils/{file}")
    
    if moved_files:
        print(f"\n✅ {len(moved_files)} arquivos movidos para pasta 'utils'")
        print("📁 Arquivos organizados:")
        for file in moved_files:
            print(f"   - utils/{file}")
    else:
        print("ℹ️ Nenhum arquivo encontrado para mover")

if __name__ == "__main__":
    print("🔧 Corrigindo diagramação do Módulo 4...")
    fix_module4_formatting()
    
    print("\n📁 Organizando arquivos desnecessários...")
    organize_files()
