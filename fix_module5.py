#!/usr/bin/env python3
"""
Script para corrigir a formatação do Módulo 5
"""

import json

def fix_module5_formatting():
    """Corrige a formatação do Módulo 5"""
    
    # Ler o notebook atual
    with open('curso/05_tarefas_fundamentais_visao_computacional.ipynb', 'r', encoding='utf-8') as f:
    ...
    with open('curso/05_tarefas_fundamentais_visao_computacional.ipynb', 'w', encoding='utf-8') as f:
        json.dump({'cells': new_cells, 'metadata': {'language_info': {'name': 'python'}}, 'nbformat': 4, 'nbformat_minor': 2}, f, ensure_ascii=False, indent=1)
    
    print("✅ Módulo 5 corrigido com sucesso!")
    print("🔧 Formatação restaurada")

if __name__ == "__main__":
    fix_module5_formatting()
